...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-utu03oa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-utu03oa.containers.anotherwebservice.com/
...
```
git clone git@github.com:Tec4Sho/container-utu03oa.git
cd container-utu03oa
```
...
```
docker attach container-utu03oa
```
